...
export function conversationTurnToWire(turn: ConversationTurn): ConversationTurnWire {
  return {
    id: turn.id,
    prompt: turn.prompt,
...
export function conversationSnapshotToWire(conversation: Conversation): ConversationTurnWire[] {
...
export function sessionsToListItems(sessions: Iterable<Session>): SessionListItem[] {
