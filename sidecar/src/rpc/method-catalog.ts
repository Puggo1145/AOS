...
function method(
	...
	overrides: Partial<
		Pick<RPCMethodSemantics, "inboundTimeoutMs" | "fastPath">
	> = {},
): RPCMethodSemantics {
	return {
		method: methodName,
		...
		kind,
		inboundTimeoutMs:
			overrides.inboundTimeoutMs ?? DEFAULT_INBOUND_HANDLER_TIMEOUT_MS,
...
const RPC_METHOD_CATALOG = {
	...
	[RPCMethod.agentSubmit]: method(
		RPCMethod.agentSubmit,
		"shellToBun",
		"request",
		{ inboundTimeoutMs: 1_000 },
	),
	[RPCMethod.agentCancel]: method(
	...
	[RPCMethod.conversationTurnStarted]: method(
		RPCMethod.conversationTurnStarted,
		"bunToShell",
		"notification",
	),
	[RPCMethod.conversationReset]: method(
		RPCMethod.conversationReset,
		"bunToShell",
		"notification",
	),

	[RPCMethod.uiToken]: method(RPCMethod.uiToken, "bunToShell", "notification"),
	[RPCMethod.uiThinking]: method(
		RPCMethod.uiThinking,
		"bunToShell",
		"notification",
	),
	[RPCMethod.uiToolCall]: method(
		RPCMethod.uiToolCall,
		"bunToShell",
		"notification",
	),
	[RPCMethod.uiStatus]: method(
		RPCMethod.uiStatus,
		"bunToShell",
		"notification",
	),
	...
	[RPCMethod.uiCompact]: method(
		RPCMethod.uiCompact,
		"bunToShell",
		"notification",
	),

	[RPCMethod.permissionRequestApproval]: method(
		RPCMethod.permissionRequestApproval,
		"bunToShell",
		"request",
	),
	[RPCMethod.permissionApprovalCancelled]: method(
		RPCMethod.permissionApprovalCancelled,
		"bunToShell",
		"notification",
	),

	[RPCMethod.providerStatus]: method(
		RPCMethod.providerStatus,
		"shellToBun",
		"request",
	),
	[RPCMethod.providerStartLogin]: method(
		RPCMethod.providerStartLogin,
		"shellToBun",
		"request",
	),
	[RPCMethod.providerCancelLogin]: method(
		RPCMethod.providerCancelLogin,
		"shellToBun",
		"request",
	),
	[RPCMethod.providerLoginStatus]: method(
		RPCMethod.providerLoginStatus,
		"bunToShell",
		"notification",
	),
	[RPCMethod.providerStatusChanged]: method(
		RPCMethod.providerStatusChanged,
		"bunToShell",
		"notification",
	),
	[RPCMethod.providerSetApiKey]: method(
		RPCMethod.providerSetApiKey,
		"shellToBun",
		"request",
	),
	[RPCMethod.providerClearApiKey]: method(
		RPCMethod.providerClearApiKey,
		"shellToBun",
		"request",
	),
	[RPCMethod.providerLogout]: method(
		RPCMethod.providerLogout,
		"shellToBun",
		"request",
	),
	...
	[RPCMethod.configSetEffort]: method(
		RPCMethod.configSetEffort,
		"shellToBun",
		"request",
	),
	[RPCMethod.configSetPermissionLevel]: method(
		RPCMethod.configSetPermissionLevel,
		"shellToBun",
		"request",
	),
	[RPCMethod.configMarkOnboardingCompleted]: method(
		RPCMethod.configMarkOnboardingCompleted,
		"shellToBun",
		"request",
	),

	[RPCMethod.computerUseListApps]: method(
		RPCMethod.computerUseListApps,
		"bunToShell",
		"request",
	),
	[RPCMethod.computerUseListWindows]: method(
		RPCMethod.computerUseListWindows,
		"bunToShell",
		"request",
	),
	[RPCMethod.computerUseGetAppState]: method(
		RPCMethod.computerUseGetAppState,
		"bunToShell",
		"request",
	),
	[RPCMethod.computerUseStartAppSession]: method(
		RPCMethod.computerUseStartAppSession,
		"bunToShell",
		"request",
	),
	[RPCMethod.computerUseStopAppSession]: method(
		RPCMethod.computerUseStopAppSession,
		"bunToShell",
		"request",
	),
	[RPCMethod.computerUsePostMouseEvent]: method(
		RPCMethod.computerUsePostMouseEvent,
		"bunToShell",
		"request",
	),
	[RPCMethod.computerUsePostKeyboardEvent]: method(
		RPCMethod.computerUsePostKeyboardEvent,
		"bunToShell",
		"request",
	),
	...
	[RPCMethod.devContextGet]: method(
		RPCMethod.devContextGet,
		"shellToBun",
		"request",
	),
	[RPCMethod.devContextChanged]: method(
		RPCMethod.devContextChanged,
		"bunToShell",
		"notification",
	),

	[RPCMethod.sessionCreate]: method(
		RPCMethod.sessionCreate,
		"shellToBun",
		"request",
	),
	[RPCMethod.sessionList]: method(
		RPCMethod.sessionList,
		"shellToBun",
		"request",
	),
	[RPCMethod.sessionActivate]: method(
		RPCMethod.sessionActivate,
		"shellToBun",
		"request",
	),
	[RPCMethod.sessionCreated]: method(
		RPCMethod.sessionCreated,
		"bunToShell",
		"notification",
	),
	[RPCMethod.sessionActivated]: method(
		RPCMethod.sessionActivated,
		"bunToShell",
		"notification",
	),
	[RPCMethod.sessionListChanged]: method(
		RPCMethod.sessionListChanged,
		"bunToShell",
		"notification",
	),
...
export function rpcMethodSemantics(
	method: string,
