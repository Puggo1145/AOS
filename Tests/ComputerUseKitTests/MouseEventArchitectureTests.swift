...
struct MouseEventArchitectureTests {
    ...
    func coreExposesMouseEventsNotLeftClickWrappers() throws {
        let source = try Self.source("Sources/ComputerUseKit/ComputerUseCore.swift")
    ...
    func mouseEventModelIsSeparateFromPosterImplementation() throws {
        let source = try Self.source("Sources/ComputerUseKit/Input/MouseEventPoster.swift")
    ...
    func keyboardEventModelIsSeparateFromPosterImplementation() throws {
        let source = try Self.source("Sources/ComputerUseKit/Input/KeyboardEventPoster.swift")
    ...
    func sessionScopedActionRPCParamsDoNotAcceptExplicitPID() throws {
        let schema = try Self.source("Sources/RPCSchema/ComputerUse.swift")
    ...
    private static func publicTypeDeclarations(file: String = #filePath) throws -> Set<String> {
        let root = URL(fileURLWithPath: file)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
        let sourcesRoot = root.appendingPathComponent("Sources/ComputerUseKit")
