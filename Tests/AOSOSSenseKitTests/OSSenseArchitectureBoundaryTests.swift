...
struct OSSenseArchitectureBoundaryTests {
    ...
    func coreDoesNotReferenceConcreteFinderAdapter() throws {
        ...
        let core = root.appendingPathComponent("Sources/AOSOSSenseKit/Core")
    ...
    func finderSelectionDoesNotEnterSenseContextTopLevel() throws {
        let root = URL(fileURLWithPath: FileManager.default.currentDirectoryPath)
        let senseContext = root.appendingPathComponent("Sources/AOSOSSenseKit/Core/SenseContext.swift")
