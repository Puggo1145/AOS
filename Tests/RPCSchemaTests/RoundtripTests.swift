...
struct RoundtripTests {
    ...
    private static func fixtureURL(_ name: String, file: String = #filePath) -> URL {
        ...
        let repoRoot = here
            .deletingLastPathComponent()  // RPCSchemaTests/
    ...
    @Test("notchProtocolVersion is 2.0.0")
    func protocolVersionConstant() {
        #expect(notchProtocolVersion == "2.0.0")
    }
    ...
    func helloFixtureCarriesCanonicalProtocolVersion() throws {
        ...
        #expect(req.params.protocolVersion == notchProtocolVersion)
    }
}
