...
// Notch Agent application-segment codes.
...
/// Canonical Notch Agent RPC error codes.
...
public enum RPCMethod {
    ...
    public static let mcpStatus = "mcp.status"
    public static let mcpGetConfig = "mcp.getConfig"
    public static let mcpAdd = "mcp.add"
    public static let mcpUpdate = "mcp.update"
    public static let mcpConnect = "mcp.connect"
    public static let mcpDisconnect = "mcp.disconnect"
    public static let mcpDelete = "mcp.delete"
    public static let mcpStatusChanged = "mcp.statusChanged"
    public static let mcpAuthStatus = "mcp.auth.status"
    public static let mcpAuthStartLogin = "mcp.auth.startLogin"
    public static let mcpAuthCancelLogin = "mcp.auth.cancelLogin"
    public static let mcpAuthLogout = "mcp.auth.logout"
    public static let mcpAuthLoginStatus = "mcp.auth.loginStatus"
    public static let mcpAuthStatusChanged = "mcp.auth.statusChanged"
    ...
    public static let computerUseStartAppSession = "computerUse.startAppSession"
    public static let computerUseStopAppSession = "computerUse.stopAppSession"
    public static let computerUsePostMouseEvent = "computerUse.postMouseEvent"
    public static let computerUsePostKeyboardEvent = "computerUse.postKeyboardEvent"
    public static let computerUsePostEventToAXElement = "computerUse.postEventToAXElement"
