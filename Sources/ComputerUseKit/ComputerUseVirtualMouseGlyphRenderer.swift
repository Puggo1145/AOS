...
enum VirtualMouseGlyphMetrics {
    static let glyphSize = CGSize(width: 126, height: 126)
    static let glyphRect = CGRect(origin: .zero, size: glyphSize)
    static let windowSize = CGSize(width: 260, height: 126)
